...
function setPhoto_info(ele) {
	...
	var $this = $(ele).exifLoad(function() {
		...
		var img_info = "<span>型号:<em class='model'>" + model + "</em></span>" + "<span>光圈:<em class='fNumber'>" + fnumber + "</em></span>" + "<br /><span>快门:<em class='ex_time'>" + time + "</em></span>" + "<span>ISO:<em class='iso'>" + iso + "</em></span>" + "<span>测光模式:<em class='mode'>" + mode + "</em></span>";
